const diTich = [
  ...
  },
  {
    ...
    loai: "Di tích kiến trúc nghệ thuật cấp quốc gia",
    diaChi: "Xã Hòa Vang, TP. Đà Nẵng",
    lat: 15.987953179337236,
    lng: 108.1518397085302,
    xepHang: "Di tích Kiến trúc Nghệ thuật cấp Quốc gia",
    moTa: "Đình làng Bồ Bản cổ kính được xây dựng lâu đời, mang đậm bản sắc văn hóa làng xã xưa của vùng đất Quảng Nam - Đà Nẵng.",
    lichSu: "Đình là nơi thờ các vị tiền hiền có công khai hoang mở cõi và là chứng nhân cho nhiều giai đoạn lịch sử hào hùng của nhân dân địa phương.",
  ...
  },
  {
    ...
    hinhAnh: "images/ongichduong.jpg",
  ...
  },
  {
    ...
    hinhAnh: "images/mactruongthanh.jpg",
  ...
  },
  {
    ...
    lichSu: "Trong kháng chiến, trường vừa là nơi dạy học, vừa là cơ sở liên lạc bí mật và che giấu các chiến sĩ hoạt động cách mạng nội đô.",
  ...
  },
  {
    ...
    loai: "Di tích lịch sử",
    diaChi: "Xã Hòa Vang, TP. Đà Nẵng",
    lat: 15.993670085545157,
    lng: 108.12305138630997,
    xepHang: "Di tích Lịch sử Cách mạng",
    moTa: "Bia tưởng niệm khắc ghi tinh thần chiến đấu quả cảm, can trường của các cô gái tuổi đôi mươi thuộc Trung đội nữ du kích Lê Thị Hồng Gấm.",
    lichSu: "Nơi đây chứng kiến trận chiến đấu anh dũng chống lại kẻ thù đông gấp bội, khẳng định ý chí kiên cường và lòng yêu nước của người phụ nữ Việt Nam.",
    hinhAnh: "images/lethihonggam.jpg",
    googleMaps: "https://www.google.com/maps?q=15.993670085545157,108.12305138630997",
    video: "https://www.youtube.com/embed/SOfv6wA-Yco"
  },
  {
    id: 13,
